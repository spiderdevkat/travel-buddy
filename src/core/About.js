        ...
        <div className="container-fluid">
            <div className="row mt-4 mb-2">
                    ...
                    <div className="border rounded shadow">
                        <div className="card m-2 ">
                            ...
                            <div class="card-body m-0 p-0">
                                <p className="text-justify p-3">TravelBuddy is an Indian Tourism website created by university Students. It is the design to get place in the top tourism website in India. TravelBuddy started as a mini project, but intended to become a major project. TravelBuddy
                                will provide many tourism packages in upcoming years. TravelBuddy aim to have a website with different language support for different regions of the country and also allowing booking to places of different countries also.
                ...
                <div className="col-md-4 col-sm-6 col-xs-12">
                    <div className="border rounded shadow">
                        <div className="card m-2 ">
                            <h5 className="m-0 text-white font-weight-bold card-header bg-success text-uppercase"><i class="fa fa-graduation-cap" aria-hidden="true"></i> Developer</h5>
                            <div class="card-body m-0 p-0">
                                <ul className="list-group">
                                    <li className="list-group-item text-info h6 font-weight-bold">Devender Kataria</li>
